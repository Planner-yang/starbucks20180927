...
<!DOCTYPE html>
<!-- saved from url=(0045)https://www.starbucks.com.cn/account/register -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <script type="text/javascript" async="" src="/static/assets/js/analytics.js">

    </script><script src="/static/assets/js/hm.js">

    </script><script async="" src="/static/assets/js/gtm.js"></script>
    ...
    <meta name="description" content="注册星享俱乐部帐户。">
    ...
    <meta property="og:title" content="注册星享俱乐部帐户">
    <meta property="og:url" content="/account/register/">
    <meta property="og:description" content="注册星享俱乐部帐户。">
    ...
    <meta name="twitter:title" content="注册星享俱乐部帐户">
    <meta name="twitter:description" content="注册星享俱乐部帐户。">
    <meta name="twitter:image" content="/assets/favicons/mstile-310x150.png">

    <!-- WeChat sharing -->
    <script>
        var WECHAT_TITLE = '星巴克官网: 注册星享俱乐部帐户';
        var WECHAT_DESC = '注册星享俱乐部帐户。';
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="180x180" href="https://www.starbucks.com.cn/assets/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" href="https://www.starbucks.com.cn/assets/favicons/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="https://www.starbucks.com.cn/assets/favicons/favicon-16x16.png" sizes="16x16">
...
<body class="lang-zh page-account-register chrome non-logged-in" ontouchstart="">
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src='https://www.googletagmanager.com/ns.html?id=GTM-MGKBKT5'
...
<div id="app-view-wrapper">
            ...
            <div class="body">
                <div class="body">
                    <nav data-reactroot="" class="container middle secondary">
                        <div class="display-1"><span>登录或创建一个新帐户 🌟</span></div>
                        <div class="tabs-wrapper">
                            <ul class="subcategories">
                                <li><a class="false" href="/login"><span>登录</span></a>
                                </li>
                                <li><a class="active"
                                       href="/register"><span>注册</span></a></li>
                                <li><a class="false"
                                       href="#"><span>关于星享俱乐部</span></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
            ...
            <div class="container">
                ...
                <footer class="footer">
                    <div class="container">
                        ...
                        <a id="en-collapse" class="lang" href="javascript:void(window.location.pathname = &quot;/en/account/register/&quot;)">
                            English
                        </a>
                        ...
                        |
                        <a id="privacy-collapse" href="https://www.starbucks.com.cn/help/legal/privacy-policy">
                            隐私政策
                        </a>
                        |
                        <a id="terms-collapse" href="https://www.starbucks.com.cn/help/legal/terms-of-starbucks-website/">
                            使用条款
                        </a>
                        <div class="legal">
                            <div class="license">
  <span>
                ...
                <div>
                    <section class="hero account-welcome-msr">
                        <div class="wrapper padded-t2">
                            <div class="flex">
                                <div class="flex2 padded-r2"><h1 class="display-2 margin-1"><span>星享俱乐部</span></h1>
                                    <p class="light">
                                        <span>加入星享俱乐部，即可在星巴克门店消费时积星星，享好礼！每累积消费50元可获赠一颗星星。星星越多，会员等级越高，好礼越丰富！</span></p><a
                                            class="button" id="msr-learn-more"
                                            href="#"><span>查看详情</span></a>
                                </div>
                                <div class="flex1 image"><img src="/static/assets/images/card-msr-unlogged.png"></div>
                            </div>
                        </div>
                    </section>
                </div>
                <section class="join-form register-form submit-box">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="actions revert">
                                        <input type="submit" class="button large" value="注册">
                                    </div>
                                    </form>
                                </div>
                                <div class="overlay" id="overlay-what-pin-code">
                                    <header class="header">
                                        <button class="icon close"></button>
                                    </header>
                                    <div class="body">
                                        <div class="wrapper center"><img src="/static/assets/images/msr-zh.png"><img
                                                src="/static/assets/images/svc-zh.png"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="app-loading"><div data-reactroot="" class="loading"></div></div>
...
<script>
    var PAGE_LANG = 'zh';
    var PAGE_TITLE = '注册星享俱乐部帐户';
    var PAGE_URL = '/account/register/';
