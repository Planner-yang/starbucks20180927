...
<head>
    ...
    <script type="text/javascript" async="" src="/static/assets/js/JsonMsg.js"></script>
    <script type="text/javascript" async="" src="/static/assets/js/TCapIframe.js"></script>
    <link rel="stylesheet" type="text/css" href="/static/assets/css/tcaptcha_animation.css">
    <link rel="stylesheet" type="text/css" href="/static/assets/css/cap_icons.css"/>
    <link rel="stylesheet" type="text/css" href="/static/assets/css/union_char_cap.css"/>

    <!-- iCheck -->
    <link rel="stylesheet" href="/static/assets/plugins/iCheck/square/green.css">
            ...
            <header class="header">
                ...
                <div class="primary">
                    <ul>
                        ...
                        <li class="account">
                            <a id="account-primary" href="#" class="active"><span
                                    data-reactroot="" class="">我的帐户</span></a>
                        </li>
                    ...
                    <nav data-reactroot="" class="container middle secondary">
                        ...
                        <div class="tabs-wrapper">
                            <ul class="subcategories">
                                <li><a class="active" href="/login"><span>登录</span></a>
                                </li>
                                <li><a class="false"
                ...
                <section class="body">
                    <div class="container middle">
                        <ul>
                            ...
                            <li>
                                <a id="account-overlay"
                                   href="#"
                                   class="active"><span data-reactroot="" class="">星享俱乐部</span></a>
                            </li>
                            ...
                            <li>
                                <a id="starbucks_reserve-overlay"
                                   href="#">
                                    星巴克臻选™
                                </a>
                            </li>
                            ...
                            <li>
                                <a id="starbucks_delivery-overlay"
                                   href="#">
                                    专星送™
                                </a>
                            </li>
                    ...
                    <div class="dashboard">
                        <div>
                            <section class="hero account-welcome-msr">
                                <div class="wrapper padded-t2">
                                    <div class="flex">
                                        <div class="flex2 padded-r2"><h1 class="display-2 margin-1"><span>星享俱乐部</span>
                                        </h1>
                                            <p class="light"><span>加入星享俱乐部，即可在星巴克门店消费时积星星，享好礼！每累积消费50元可获赠一颗星星。星星越多，会员等级越高，好礼越丰富！</span>
                                            </p><a class="button" id="msr-learn-more"
                                                   href="#"><span>查看详情</span></a>
                                        </div>
                                        <div class="flex1 image"><img src="/static/assets/images/card-msr-unlogged.png">
                                        </div>
                                    </div>
                                </div>
                            </section>
                                    ...
                                    <form action="login" method="post">
                                        <div class="form-field">
                                            ...
                                            <div class="field floating">
                                                <div class="ok">
                                                    <input type="text" name="name" placeholder="用户名或者电子邮箱" required="">
                                        ...
                                        <div class="checkbox icheck">
                                            <label>
                                                <input name="rememberMe"
                                                       type="checkbox" ${admin == null ? "":"checked"}> 记住我
                                            </label>
                                        </div>
                                        <p><a id="sign-in-forgot-password" href="#" class="link"><span>忘记密码？</span></a>
                                        </p>
                                                ...
                                                <div class="captcha_aq char">
                                                    <div class="container_wrap">
                                                        <div class="container_head">
                                                            <div class="title" id="title1" style="color:#00A862;">
                                                                安全验证
                                                            </div>
                                                            ...
                                                            <div class="capachArea" ctrl="capachArea">
                                                                <div class="layout">
                                                                    ...
                                                                    <div class="char">
                                                                        ...
                                                                        <div class="right">
                                                                            <%--<input id="capAns" type="text" class="cinput" placeholder="请输入验证码" />--%>
                                                                            <input type="text" class="cinput"
                                                                                   id="kaptcha" name="kaptcha"
                                                                                   placeholder="验证码">
                                                                        </div>
                                                                        <div id="cap_tip" class="fb_tip warn">
                                                                            <span class="bkg"></span>
                                                                            <span class="word"
                                                                                  id="tip_word">请输入验证码</span>
                                                                        </div>
                                        ...
                                        <div class="actions">
                                            <input type="submit" class="button large" value="登录">
                                        </div>
                                    </form>
                        ...
                        <section class="account-join">
                            <div class="wrapper padded-t1">
                                <div class="flex2 padded-r2"><h2 class="gold"><span>加入星享俱乐部</span></h2>
                                    <p class="light"><span>只需几分钟，便可成功注册星享俱乐部帐户，成为“星”会员，立即开启集星之旅。</span></p></div>
                                <div class="flex1 creat-account"><a id="create-account" class="button"
                                                                    href="/register"><span>注册</span></a>
                                </div>
                            </div>
                        </section>
                    </div>
...
<script type="text/javascript" src="/static/assets/js/app.bundle.js"></script>
...
<script src="/static/assets/js/TCapIframeApi.js" async=""></script>
...
<script>
    $(function () {
        // 刷新验证码
        $("#verification, #reload, #submit").bind("click", function () {
