    ...
    <nav id="nav">
        <div class="container">
            ...
            <%--<c:otherwise>
                <div class="body">
                    <div class="container middle secondary">
                        <div data-reactroot=""><span><div class="display-1"><span>${tbUser.username}&nbsp;☕</span></div><footer
                                class="account margin2 mobile-hidden"><img
                                src="/static/assets/images/icon-account.svg"><span><span>${tbUser.email}</span></span>
                           </footer></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper">
                        <div class="scroll-items">
                            ...
                            <a id="home-blog-fundamentals" target="_blank" href="#" class="thumbnail rect card">
                                <div class="preview"
                                     style="background-image: url(/static/assets/images/coffeehouse-4-fundamentals-kv.jpg)"></div>
                            ...
                            <a id="home-blog-roast" target="_blank" href="#" class="thumbnail rect card">
                                <div class="preview"
                                     style="background-image: url(/static/assets/images/coffeehouse-roast-story-kv.jpg)"></div>
                                <span class="tag">咖啡知识</span>
                                <!-- <time>08/07/2017</time> -->
                                <strong>咖啡烘焙</strong>
                            </a>
                            <a id="home-blog-pour" target="_blank" href="#" class="thumbnail rect card">
                                <div class="preview"
                                     style="background-image: url(/static/assets/images/coffeehouse-pour-over-kv.jpg)"></div>
                                <span class="tag">咖啡品鉴</span>
                                <!-- <time>08/07/2017</time> -->
                                <strong>手冲咖啡</strong>
                            </a>
